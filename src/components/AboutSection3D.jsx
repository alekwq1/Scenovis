...
// Minimalistyczna animacja przycisku
...
// Loader ze spinnerem i procentem
          ...
          >
            ...
            >
              ...
              <group scale={isMobile ? 1.65 : 1.5}>
                <Suspense fallback={<ModelLoader lang={lang} key={lang} />}>
                  <TwinModel
                    hotspots={HOTSPOTS}
...
// ===================
// TwinModel (osobny komponent, ładuje GLB!)
// ===================
function TwinModel({
  hotspots,
  onHotspotClick,
  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: "0 2px 14px 0 rgba(92,198,236,0.09)",
        borderRadius: 18,
        zIndex: 1000,
        ...
        >
          <img
            ...
            style={{
              ...
              background: "#19212a",
              borderRadius: 12,
              boxShadow: "0 2px 10px 0 rgba(92,198,236,0.07)",
              pointerEvents: "none",
              userSelect: "none",
              display: "block",
            }}
      ...
      {hotspot.extra && (
        <div
          style={{
            marginTop: "10px",
            padding: "8px",
            background: "rgba(92,198,236,0.05)",
            borderRadius: "7px",
